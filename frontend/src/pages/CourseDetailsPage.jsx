...
      try {
        setLoading(true);
        // Get the course data directly from the service
        const courseData = await courseService.getCourseById(id);
        
        // --- THE CORRECT FIX ---
        // The service file already returns the JSON object, so we set the state directly.
...
              <button 
                className="flex-grow bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition duration-300"
              >
                Enroll Now
              </button>
              <button 
